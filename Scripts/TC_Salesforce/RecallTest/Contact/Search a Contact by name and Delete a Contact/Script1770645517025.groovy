...
WebUI.verifyElementText(findTestObject('Contact/Page_Delete Contact/txt_DeleteContact'), 'Are you sure you want to delete this contact?')

WebUI.click(findTestObject('Contact/Page_Delete Contact/btn_Delete'))

WebUI.verifyElementText(findTestObject('Contact/Page_Delete Contact/txt_Toaster Msg'), ('Contact "' + contactName) + 
    '" was deleted. Undo')
