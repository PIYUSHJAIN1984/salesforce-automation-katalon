...
opptyName = WebUI.getText(findTestObject('New Folder (1)/Sales/Opportunity/Page_Recently Viewed  Opportunities  Salesforce/getOpptyName'))

WebUI.click(findTestObject('New Folder (1)/Contact/Page_Recently Viewed  Contacts  Salesforce/input_Search this list'))

WebUI.setText(findTestObject('New Folder (1)/Sales/Opportunity/Page_Recently Viewed  Opportunities  Salesforce/input_Search this list'), 
    opptyName)
...
WebUI.verifyElementText(findTestObject('New Folder (1)/Sales/Opportunity/Page_Delete Oppty/txt_DeleteOppty'), 'Are you sure you want to delete this opportunity?')

WebUI.click(findTestObject('New Folder (1)/Sales/Opportunity/Page_Delete Oppty/btn_Delete'))

WebUI.verifyElementText(findTestObject('New Folder (1)/Sales/Opportunity/Page_Delete Oppty/txt_Toaster Msg'), ('Opportunity "' + 
