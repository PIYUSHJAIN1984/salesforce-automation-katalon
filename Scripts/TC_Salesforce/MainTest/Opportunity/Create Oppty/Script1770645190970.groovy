...
WebUI.callTestCase(findTestCase('TC_Salesforce/RecallTest/Opportunity/Create Opportunity'), [('contactName') : ''
        , ('opportunityName') : 'New Business'], FailureHandling.STOP_ON_FAILURE)
