...
public class NavigateAccountList {
	...
	def checkAccountList() {
		...
		println currentUrl
		String targetUrl = "https://data-momentum-7717.lightning.force.com/lightning/o/Account/list?filterName=Recent"
		...
		if (currentUrl.equals(targetUrl)) {
			...
			WebUI.enhancedClick(findTestObject('New Folder (1)/Page_Home  Salesforce/img_Accounts'))
		}
	}
